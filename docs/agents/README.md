...
Read root `AGENTS.md` first. Load one document below only when its trigger
...
| [`fallow.md`](fallow.md) | **Repository quality:** Fallow setup, changed-code quality, warning policy, comparison-base selection, or Fallow failure repair. |
