...
| Where are command and result meanings owned? | Command Vocabulary and Result Vocabulary | `docs/adr/0001-language-to-topology.md` | `src/modules/maintenance-command-contract/command-vocabulary.ts` and `result-vocabulary.ts` | Governing Module Contract Tests | Maintenance Command Contract Implementation |
