...
| Where is repository-wide quality policy owned? | Repository Quality Tooling | `docs/adr/0005-simple-repository-quality-ownership.md`; Biome guidance: [`docs/agents/biome.md`](docs/agents/biome.md); Fallow guidance: [`docs/agents/fallow.md`](docs/agents/fallow.md) | `biome.jsonc`, `.fallowrc.json`, and `tooling/repository-quality/` | `tooling/repository-quality/contract-tests/` | Biome, TypeScript, native Fallow, and Repository Verification |
| What owns cross-owner manifest and filesystem checks? | Repository Verification | `docs/adr/0005-simple-repository-quality-ownership.md` | `tooling/repository-quality/repository-verification.ts` | `tooling/repository-quality/contract-tests/repository-verification.test.ts` | `tooling/repository-quality/verify-repository.ts` |
...
| How are claims reduced without promotion? | Qualification Evidence | `docs/adr/0001-language-to-topology.md`; public runtime: `docs/adr/0006-qualification-evidence-public-runtime.md` | `src/modules/qualification-evidence/interface.ts` | `src/modules/qualification-evidence/contract-tests/` and installed-consumer Clean Fixture proof | `src/modules/qualification-evidence/implementation/` |
...
| Where are cross-Module and higher-layer claims proved? | Clean Fixture and Verification Profile | `docs/adr/0001-language-to-topology.md`; repository-policy split: `docs/adr/0005-simple-repository-quality-ownership.md` | `clean-fixture/` is outside Source Tree | `clean-fixture/personal-verification-profile/contract-tests/` and `clean-fixture/public-verification-profile/contract-tests/` | Independent proof, not repository governance or package Implementation |
