...
test("accepts literal Bun JUnit and refuses malformed, incomplete, non-green, or drifted documents", () => {
	...
	for (const [report, code] of [
		[validJunit.replace('tests="144"', 'tests="143"'), "report-count-mismatch"], [validJunit.replace(`file="${first}"`, 'file="unknown.test.ts"'), "report-file-drift"], [validJunit.replace(`name="case-0" file="${first}" time="0" assertions="0" />`, `name="case-0" file="${first}" time="0" assertions="0"><failure /></testcase>`), "report-failed"], [validJunit.replace(`name="case-0" file="${first}" time="0" assertions="0" />`, `name="case-0" file="${first}" time="0" assertions="0"><error>details</error></testcase>`), "report-failed"], [validJunit.replace(`name="case-0" file="${first}" time="0" assertions="0" />`, `name="case-0" file="${first}" time="0" assertions="0"><skipped /></testcase>`), "report-skipped"], [validJunit.replace(`tests="3" assertions="0" failures="0"`, `tests="2" assertions="0" failures="0"`), "report-count-mismatch"], [`junk${validJunit}`, "report-malformed"], [`${validJunit}junk`, "report-malformed"], [validJunit.replace("</testsuites>", "<unknown /></testsuites>"), "report-malformed"], [validJunit.replace("</testsuite>", ""), "report-malformed"], [validJunit.replace("failures=\"0\"", "failures=\"no\""), "report-malformed"], ["<?xml version=\"1.0\" encoding=\"UTF-8\"?><testsuites tests=\"0\" failures=\"0\" skipped=\"0\"></testsuites>", "report-file-drift"],
