...
const junitRows = [
	["clean-fixture/personal-verification-profile/contract-tests/package-export-catalog.test.ts", 3], ["src/admission-bootstrap/contract-tests/admitted-identity-before-execution.test.ts", 2], ["src/admission-bootstrap/contract-tests/identity-refusal.test.ts", 6], ["src/admission-bootstrap/contract-tests/source-checkout-admission.test.ts", 6], ["src/modules/maintenance-command-contract/contract-tests/effect-class-and-retry-safety.test.ts", 9], ["src/modules/maintenance-command-contract/contract-tests/human-and-agent-result-vocabulary.test.ts", 7], ["src/modules/maintenance-command-contract/contract-tests/branch-station-catalog.test.ts", 8], ["src/modules/maintenance-command-contract/contract-tests/wire-command-and-binding.test.ts", 12], ["src/modules/maintenance-command-contract/contract-tests/source-checkout-binding.test.ts", 5], ["src/modules/maintenance-command-contract/contract-tests/package-result-and-admission.test.ts", 5], ["src/modules/qualification-evidence/contract-tests/candidate-lineage-reduction.test.ts", 8], ["src/modules/qualification-evidence/contract-tests/proof-layer-and-non-claim.test.ts", 7], ["clean-fixture/personal-verification-profile/contract-tests/admission-and-invocation.test.ts", 3], ["clean-fixture/personal-verification-profile/contract-tests/installation-evidence.test.ts", 3], ["clean-fixture/personal-verification-profile/contract-tests/fresh-native-non-claims.test.ts", 2], ["clean-fixture/public-verification-profile/contract-tests/profile-non-promotion.test.ts", 2], ["clean-fixture/personal-verification-profile/contract-tests/maintenance-cli.test.ts", 8], ["clean-fixture/personal-verification-profile/contract-tests/maintenance-cli-local-link.test.ts", 8], ["src/adapters/maintenance-command-facade/contract-tests/command-surface.test.ts", 13], ["src/adapters/maintenance-command-facade/contract-tests/public-process.test.ts", 19], ["src/adapters/maintenance-command-facade/contract-tests/observability.test.ts", 12], ["src/adapters/maintenance-command-facade/contract-tests/source-checkout-observation.test.ts", 7], ["src/adapters/maintenance-command-facade/contract-tests/package-public-process.test.ts", 12], ["clean-fixture/personal-verification-profile/contract-tests/source-checkout-admission.test.ts", 7], ["clean-fixture/personal-verification-profile/contract-tests/payload-package.test.ts", 7], ["clean-fixture/personal-verification-profile/contract-tests/payload-check-materialize.test.ts", 4], ["src/modules/plugin-payload-production/contract-tests/serialized-values.test.ts", 3], ["src/modules/plugin-payload-production/contract-tests/deterministic-plugin-payload.test.ts", 20], ["src/modules/plugin-payload-production/contract-tests/unsafe-inventory-refusal.test.ts", 20], ["src/modules/plugin-payload-production/contract-tests/check-materialize.test.ts", 15], ["src/modules/plugin-payload-production/contract-tests/production-input-refusal.test.ts", 10], ["src/modules/release-and-git-engine/contract-tests/serialized-values.test.ts", 3], ["src/modules/harness-journeys/contract-tests/serialized-values.test.ts", 4], ["src/modules/canary-qualification/contract-tests/serialized-values.test.ts", 3], ["src/modules/canary-qualification/contract-tests/authority-source.test.ts", 3],
] as const
const validJunit = `<?xml version="1.0" encoding="UTF-8"?>\n<testsuites name="bun test" tests="266" assertions="0" failures="0" skipped="0" time="0">\n${junitRows.map(([file, count]) => `  <testsuite name="${file}" file="${file}" tests="${count}" assertions="0" failures="0" skipped="0" time="0">${Array.from({ length: count }, (_, index) => `<testcase name="case-${index}" file="${file}" time="0" assertions="0" />`).join("")}</testsuite>`).join("\n")}\n</testsuites>`

test("accepts only the ordered 35-file current-stage selector", () => {
...
test("accepts literal Bun JUnit and refuses malformed, incomplete, non-green, or drifted documents", () => {
	...
	for (const [report, code] of [
		[validJunit.replace('tests="266"', 'tests="172"'), "report-count-mismatch"], [validJunit.replace(`file="${first}"`, 'file="unknown.test.ts"'), "report-file-drift"], [validJunit.replace(`name="case-0" file="${first}" time="0" assertions="0" />`, `name="case-0" file="${first}" time="0" assertions="0"><failure /></testcase>`), "report-failed"], [validJunit.replace(`name="case-0" file="${first}" time="0" assertions="0" />`, `name="case-0" file="${first}" time="0" assertions="0"><error>details</error></testcase>`), "report-failed"], [validJunit.replace(`name="case-0" file="${first}" time="0" assertions="0" />`, `name="case-0" file="${first}" time="0" assertions="0"><skipped /></testcase>`), "report-skipped"], [validJunit.replace(`tests="3" assertions="0" failures="0"`, `tests="2" assertions="0" failures="0"`), "report-count-mismatch"], [`junk${validJunit}`, "report-malformed"], [`${validJunit}junk`, "report-malformed"], [validJunit.replace("</testsuites>", "<unknown /></testsuites>"), "report-malformed"], [validJunit.replace("</testsuite>", ""), "report-malformed"], [validJunit.replace("failures=\"0\"", "failures=\"no\""), "report-malformed"], ["<?xml version=\"1.0\" encoding=\"UTF-8\"?><testsuites tests=\"0\" failures=\"0\" skipped=\"0\"></testsuites>", "report-file-drift"],
