...
export const expectedSubpathTypeExports = {
  "./admission-bootstrap": ["AdmissionRefusal", "AdmissionRequest", "SourceCheckoutAdmissionRequest", "SourceCheckoutAdmissionRefusal", "AdmittedSourceCheckoutIdentity", "AdmissionResult", "SourceCheckoutAdmissionResult", "AdmissionBootstrap"],
  "./plugin-payload-production": [
    "PayloadRelease", "PreparedFileDeclaration", "PreparedProjectionRole", "PreparedProjectionDeclaration",
    "PreparedPayloadDeclaration", "PayloadCategory", "PayloadHookDependence", "PluginPayloadMetadata",
    "PayloadSkillProduction", "PluginPayloadSkillConfiguration", "PluginPayloadConfiguration",
    "PayloadSourceProjectionPaths", "PayloadCheckRequest", "PayloadMaterializeRequest", "PayloadPackageRequest",
    "PayloadProductionRequest", "PreparedPluginPayload", "PreparedPayloadCandidate", "PayloadArtifactRecord", "PayloadArtifacts",
    "PayloadRefusalCode", "PayloadRefusal", "PayloadFailureCode", "PayloadPublicationState",
    "MaterializationFailure", "PayloadCheckResult", "PayloadMaterializeResult", "PayloadProductionResult",
  ...
  "./release-and-git-engine": [
    ...
    "AdmissionRefusal", "SourceCheckoutCandidate", "SourceCheckoutAdmissionRequest", "SourceCheckoutAdmissionRefusal", "AdmittedSourceCheckoutIdentity", "PackageObservation", "ReleaseRequest", "ReleaseMutationRequest",
  ...
  "./canary-qualification": [
    "CanaryCandidate", "CanaryPlan", "CanaryAuthorityReference", "ProtectedCanaryAuthority",
    "CanaryAuthoritySourceRefusalCode", "CanaryAuthoritySourceRefusal",
    "CanaryAuthoritySourceResolution", "CanaryAuthoritySource", "CanaryResult", "CanaryQualification",
  ],
  "./qualification-evidence": [
...
export const expectedInstalledFiles = [
  ...
  "clean-fixture/local-link-contract-proof.ts",
  "clean-fixture/personal-verification-profile/contract-tests/adapters/admission-source-projection.ts",
  "clean-fixture/personal-verification-profile/contract-tests/adapters/admitted-package-consumer.ts",
  ...
  "clean-fixture/personal-verification-profile/contract-tests/adapters/local-link-contract-subject.ts",
  ...
  "docs/adr/0008-package-prepared-plugin-payload.md",
  "docs/adr/0009-complete-plugin-payload-check-and-materialize.md",
  ...
  "src/modules/maintenance-command-contract/implementation/trusted-command-binding.ts",
  ...
  "src/modules/plugin-payload-production/contract-tests/fixtures/payload-production-fixture.ts",
  ...
  "src/modules/plugin-payload-production/implementation/payload-candidate.ts",
  ...
  "tooling/current-stage-test-runner.ts",
  "tooling/repository-quality/contract-tests/biome-policy.test.ts",
  "tooling/repository-quality/contract-tests/current-stage-test-runner.test.ts",
...
export const expectedBranchStationSourceSha256 =
  "sha256:e96702e13635dad989ba842ea486fac1524bcd4f69bf9597021d7d60b90ff7e6" as const
